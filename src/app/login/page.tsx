...
export default function LoginPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        alert("Frontend only: login not yet connected to backend!");
    };
        ...
        <main className="relative min-h-[calc(100vh-64px)] overflow-hidden bg-gradient-to-b from-purple-950 to-violet-900 text-white">
          ...
          <span className="inline-flex items-center gap-2 rounded-full border border-yellow-400/40 bg-yellow-400/10 px-3 py-1 text-xs font-semibold text-yellow-300">
            {/* small sparkle */}
              ...
              <path fill="currentColor" d="M12 2l1.8 4.7L18 8.5l-4.2 1.8L12 15l-1.8-4.7L6 8.5l4.2-1.8z" />
            </svg>
            Member Access
          </span>
                </div>
          ...
          <span className="bg-gradient-to-r from-yellow-300 via-pink-300 to-fuchsia-400 bg-clip-text text-transparent">
            Login
                ...
                >
                    {/* Email */}
                    <div className="mb-4">
                        <label htmlFor="email" className="mb-1.5 block text-sm font-medium text-purple-100">
                            Email
                        </label>
                        <input
                            id="email"
                    ...
                    {/* Password */}
                    <div className="mb-2">
                        <label htmlFor="password" className="mb-1.5 block text-sm font-medium text-purple-100">
                            Password
                        </label>
                        <input
                            id="password"
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <div className="text-xs text-purple-200/80">
                            ...
                            <button
                                ...
                                onClick={() => alert("Frontend only: reset coming soon.")}
                            >
                                Reset
                            </button>
                        </div>
                        <Link href="/" className="text-xs text-purple-200/80 underline-offset-4 hover:underline">
                            ← Back Home
                        </Link>
                    </div>
                    ...
                    <p className="mt-4 text-center text-sm text-purple-100/80">
                        ...
                        <Link href="/signup" className="font-semibold text-yellow-300 hover:underline">
                            Sign up
                        </Link>
                    </p>
                </form>
